  ...
  return (
    <section id="home" className="w-full min-h-screen pt-16 bg-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 right-10 w-96 h-96 bg-red-600 opacity-5 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-black opacity-5 rounded-full blur-3xl" />
      </div>
